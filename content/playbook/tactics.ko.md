...
> [!TIP] 당일을 이기는 마인드셋
> full loop는 연속된 여러 대화로 구성될 수 있어 지식뿐 아니라 에너지와 전환 능력도 요구합니다. 라운드 수와 의사결정 방식은 지원 건마다 다르지만, 지나간 라운드의 자기평가를 다음 라운드로 끌고 가지 않는 원칙은 유효합니다. 실제 일정에 맞춰 식사·휴식·이동·접속 루틴을 준비하세요.
...
| 국면 | 라운드 | 위험 | 전술 |
| --- | --- | --- | --- |
| **오프닝** | 첫 구간 | 카페인 과다, 서두름 | 평소보다 조금 천천히, 기본기를 깔끔하게 |
| **The dip** | 정오 / 점심 후 | 에너지 저하, 실수 | 단백질 위주 가벼운 점심, 라운드 사이 진짜 산책 |
| **The grind** | 후반 구간 | 정신적 피로, 짧은 답변 | *구조*에 더 기대기 — 창의력이 흔들릴 때 프레임워크가 실어 나름 |
...
당일 가장 값진 스킬 중 하나입니다. 라운드별 피드백의 결합 방식은 알 수 없지만, 이미 끝난 답변을 반추하면 다음 대화의 집중력까지 잃습니다. 통제 가능한 다음 행동으로 주의를 돌리세요.
...
- **즉흥적인 자기평가를 공유하지 마세요.** 면접관이나 recruiter에게 “그 라운드 망친 것 같아요”라고 말하면 확인되지 않은 부정적 해석을 먼저 제시하게 됩니다.
- **결정 방식을 추측하지 마세요.** 한 라운드의 가중치는 역할과 rubric에 따라 다릅니다. 결과를 계산하려 하지 말고 다음 라운드에서 보여줄 signal에 집중하세요.
...
대면 일정으로 확인됐다면 지구력 원칙에 이동·출입·물리적 whiteboard 변수를 더합니다.
...
- <strong>방 사이 이동</strong>을 리셋 창으로 활용하세요. 안내자와의 대화도 signal로 카운트되니 따뜻함을 유지하세요.
...
| 페이싱 | 초반은 평소보다 조금 천천히, 라운드 사이 리셋, 후반은 프레임워크 활용 |
| 라운드 사이 | 리셋 — 지난 라운드를 되감지 말 것 |
| 망친 라운드 | 이름 붙이기, 짧게 리셋, 결과 추측 없이 구조로 재입장 |
| 노트 | 컴포넌트 + 이름 + 그들의 질문, 긴 스크립트 읽지 않기 |
| 긴장 | box-breathe, "긴장"이 아니라 "설렘", 백지보다 구조 |
| 피할 것 | 면접관이나 recruiter에게 즉흥적으로 "그 라운드 망친 것 같아요"라고 평가 |
